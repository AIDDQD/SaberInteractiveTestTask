...
public class DeserializeTest {
    ...
    public void Deserialize_TwoItems() {
        var raw = @"[{Data=""test-test"",Previous=null,Next=1,Random=null},{Data=""super-test"",Previous=0,Next=null,Random=null},]";
    ...
    [Fact]
    public void Deserialize_Random() {
        var raw = @"[{Data=""test-test"",Previous=null,Next=1,Random=1},{Data=""super-test"",Previous=0,Next=null,Random=null},]";
